      ...
      <div className="flex flex-col gap-4 font-sans text-xs select-none">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <label className="font-semibold text-neutral-500 uppercase text-[9px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="font-semibold text-neutral-500 uppercase text-[9px]">Voice Selection</label>
              <select
                value={vc.accent || ''}
    ...
    return (
      <div className="flex flex-col gap-4 font-sans text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="col-span-1 sm:col-span-2 flex flex-col gap-1.5">
            <label className="font-semibold text-neutral-500 uppercase text-[9px]">Target Companies (comma separated)</label>
            <input
              type="text"
