            ...
            <SectionCard title="Priority Focus Areas" subtitle="Analysis of study weaknesses" headerBg="bg-neutral-50/50">
              <div className="font-sans text-xs flex flex-col gap-3">
                <div className="border border-[var(--border-default)] p-3.5 rounded-none bg-[var(--bg-tertiary)] flex flex-col">
                  ...
                  <span className="font-sans font-bold text-sm text-red-400 mt-1">{weaknesses.weakest_topic}</span>
                </div>
                <div className="border border-[var(--border-default)] p-3.5 rounded-none bg-[var(--bg-tertiary)] flex flex-col">
                  <span className="text-[9px] font-semibold text-[var(--text-muted)] uppercase">Most Practiced Track</span>
                  <span className="font-sans font-bold text-sm text-[var(--text-primary)] mt-1">{weaknesses.most_practiced_subject}</span>
                </div>
              </div>
            </SectionCard>
                ...
                <div className="flex flex-col justify-between h-full font-sans text-xs">
                  <div className="flex flex-col gap-2 py-4">
                    ...
                    <div className="flex justify-between items-center text-[10.5px] mt-1.5 font-medium text-[var(--text-secondary)]">
                      <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-none bg-[var(--accent-teal)]" /> Easy ({question_difficulty.easy})</span>
                      <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-none bg-[var(--accent-amber)]" /> Medium ({question_difficulty.medium})</span>
                      <span className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-none bg-[var(--accent-coral)]" /> Hard ({question_difficulty.hard})</span>
                    </div>
                  </div>
